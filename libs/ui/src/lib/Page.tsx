...
export function Page({ children }: { children: React.ReactElement | React.ReactElement[] }) {
	return (
		<>
			{/*
			...
			<div className="min-h-full">
								...
								<div className="border-t border-sky-700 pt-4 pb-3">
									<div className="flex items-center px-5">
										...
										<div className="ml-3">
											...
											<div className="text-sm font-medium text-sky-300">{user.email}</div>
										</div>
										<button
											type="button"
				...
				<header className="dark:bg-slate-900 bg-white shadow-sm">
					<div className="mx-auto max-w-7xl py-4 px-4 sm:px-6 lg:px-8">
						<h1 className="text-lg font-semibold leading-6 text-gray-900 dark:text-gray-100">Dashboard</h1>
					</div>
				</header>
				<main>
